...
public class Application {
	public static final Double GEWINNPAUSCHALE = 0.2;
	public static final Integer MINDESTANZAHL = 5;
	...
	@Configuration
	static class GetraenkehandelWebConfiguration extends SalespointWebConfiguration {
